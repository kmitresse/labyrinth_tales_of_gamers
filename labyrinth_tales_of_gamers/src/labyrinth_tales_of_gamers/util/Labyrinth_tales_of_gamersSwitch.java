 ...
 * @generated
 */
public class Labyrinth_tales_of_gamersSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Labyrinth_tales_of_gamersSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Labyrinth_tales_of_gamersPackage.HINT: {
				...
				if (result == null) result = caseEntity(hint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
...
} //Labyrinth_tales_of_gamersSwitch
